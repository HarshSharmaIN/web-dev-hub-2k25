...
const Sidebar = () => {
  ...
  return (
    <div className='flex  flex-col gap-2 '>
      ...
      <div onClick={()=>titleClick('dish')} className='font-bold text-blue-900 flex items-center '>{titles.slice(0,1)} <div className='flex-grow'/> <MdKeyboardArrowDown style={{fontSize: '20px'}}/></div>
      ...
      <div onClick={()=>titleClick('ing')} className='font-bold text-blue-900 flex items-center '>{titles.slice(1,2)} <div className='flex-grow'/>  <MdKeyboardArrowDown style={{fontSize: '20px'}}/></div>
      ...
      <div onClick={()=>titleClick('region')} className='font-bold text-blue-900 flex items-center '>{titles.slice(2,3)} <div className='flex-grow'/>  <MdKeyboardArrowDown style={{fontSize: '20px'}}/></div>
